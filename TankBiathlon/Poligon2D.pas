...
begin
  ...
  if( Res = JTP_OK ) then begin
    ...
    //  закрасим танки
    Color.VSet(1,0,0,1);    Vehicles[1].SetColor( Color );
    Color.VSet(0,1,0,1);    Vehicles[2].SetColor( Color );
    Color.VSet(0,0,1,1);    Vehicles[3].SetColor( Color );
    Color.VSet(1,1,0,1);    Vehicles[4].SetColor( Color );
  end;
